    ...
    <div className="flex min-h-screen items-center justify-center">
      <div className="w-full max-w-lg p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
          ...
          >
            <svg className="w-8 h-8 mx-auto mb-2 text-white/60 group-hover:text-white transition-colors" viewBox="0 0 24 24" fill="currentColor">
              <path d="M0 3.449L9.75 2.1v9.451H0m10.949-9.602L24 0v11.4H10.949M0 12.6h9.75v9.451L0 20.699M10.949 12.6H24V24l-12.9-1.801" />
            </svg>
            <p className="font-medium text-sm">Windows</p>
            <p className="text-xs text-white/60 mt-1">Windows 10 or later</p>
            <span className="inline-block mt-2 text-xs text-white/55">Coming soon</span>
          </a>
          <a
            href="#"
            className="glass-card p-5 text-center hover:border-white/20 transition-colors group"
          >
            ...
            <p className="text-xs text-white/60 mt-1">macOS 11 or later</p>
            <span className="inline-block mt-2 text-xs text-white/55">Coming soon</span>
          </a>
        </div>

        <div className="text-center">
          <p className="text-xs text-white/55 mb-3">Need help? Contact your administrator.</p>
